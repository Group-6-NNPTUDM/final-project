          ...
          <div class="col-8">
            ...
            <div class="row product-title">
              <span>
                ...
                <button class="btn btn-primary btn-sm" type="button">Chia sẻ</button>
              </span>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="row" style="width:100%; height: auto; border: 1px solid #ccc;margin-left: 2px">
                  <div class="phone">
                    <span>Hồ Chí Minh :</span> 0919 011 011
                    <br>
                  </div>
                  <div class="phone">
                    <span>Hà Nội :</span> 0964 600 600
                  </div>
                  <div class="delivery">
                    <ul style="list-style: none">
                      <li>Thanh toán thẻ ATM miễn phí</li>
                      <li>Thanh toán thẻ MASTER, VISA <strong>+1.5%</strong></li>
                ...
                <div class="row" style="margin-top: 10px">
                  <img src="https://mac24h.vn/images/promo/49/68540C4C-BE27-48B2-A3AF-7EAA78738021.jpeg?t=1666949572" alt="">
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  async mounted() {
      ...
      this.product.price = this.product.price.toLocaleString('it-IT', {style : 'currency', currency : 'VND'});
  },
  components: {
      HeaderVue, 
      FooterVue,
...
const getProductInfomation = async (id) => {
    const response = await axios.get(`${UrlConstant.URL}products/${id}`)
        .then((res) => res.data)
